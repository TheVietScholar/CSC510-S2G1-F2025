...
public class DriverController {
    ...
    public ResponseEntity<ApiResponse<List<DriverDTO>>> getAvailableDrivers() {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(driverDTOs, "Available drivers retrieved successfully"));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ApiResponse<List<DriverDTO>>> getAllDrivers() {
        try {
            ...
            List<DriverDTO> driverDTOs = allDrivers.stream()
                    .map(this::convertToDTO)
                    .collect(Collectors.toList());
            return ResponseEntity.ok(ApiResponse.success(driverDTOs, "All drivers retrieved successfully"));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
