...
/**
 * Custom annotations for role-based access control. These make controller methods cleaner and more
 * readable.
 */
public class RoleAnnotations {
  ...
  /**
   * Check if the authenticated user is accessing their own resource. Usage: @IsSelfOrAdmin(idParam
   * = "id")
   */
