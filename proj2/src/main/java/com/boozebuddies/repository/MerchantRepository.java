 ...
 * methods to search, filter, and analyze merchant information such as activity status,
 * cuisine type, and ratings.
 * </p>
 *
 * <p>Custom query methods include:</p>
 * <ul>
 *   <li>{@link #findByName(String)} - Finds a merchant by exact name.</li>
 *   <li>{@link #findByCuisineType(String)} - Retrieves merchants by cuisine type.</li>
 *   <li>{@link #findByIsActive(boolean)} - Finds merchants by their active/inactive status.</li>
 *   <li>{@link #findByNameContainingIgnoreCase(String)} - Searches merchants whose names contain a given substring (case-insensitive).</li>
 *   <li>{@link #findActiveByCuisineType(String)} - Finds active merchants by a specific cuisine type.</li>
 *   <li>{@link #searchActiveMerchants(String)} - Searches active merchants by keyword in name or cuisine type.</li>
 *   <li>{@link #findTopRatedActiveMerchants()} - Retrieves top-rated merchants who are currently active.</li>
 *   <li>{@link #findRecentActiveMerchants(int)} - Retrieves the most recently added active merchants, limited by count.</li>
 *   <li>{@link #existsByName(String)} - Checks if a merchant exists with a specific name.</li>
 *   <li>{@link #existsByEmail(String)} - Checks if a merchant exists with a specific email address.</li>
 * </ul>
 *
 * <p>This repository supports merchant discovery, search, and performance analytics
 * features across the BoozeBuddies platform.</p>
 */
@Repository
public interface MerchantRepository extends JpaRepository<Merchant, Long> {
  ...
  /**
   * Searches for active merchants by keyword, matching either name or cuisine type.
  ...
  /**
   * Retrieves a limited number of the most recently created active merchants.
