...
public interface UserRepository extends JpaRepository<User, Long> {
   ...
   * Used for JWT token refresh flow.
   */
   ...
   * Updated to work with Role enum.
   */
  ...
  /**
   * Find users of legal drinking age (21+).
   ...
   */
  @Query("SELECT u FROM User u WHERE u.isActive = true AND u.isEmailVerified = true AND u.ageVerified = true")
