...
public interface OrderRepository extends JpaRepository<Order, Long> {
  ...
  /**
   * Retrieves all orders belonging to a specific customer, sorted by creation date (most recent first).
   *
   ...
   * <p>
   * Returns each merchant’s ID and the sum of total amounts for orders with
   * {@link OrderStatus#DELIVERED}.
   * </p>
   *
   * @return a list of object arrays where each element contains
   *         {@code [merchantId, totalDeliveredAmount]}
   */
  @Query(
