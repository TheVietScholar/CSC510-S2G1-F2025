...
public interface OrderRepository extends JpaRepository<Order, Long> {
        ...
        List<Order> findByPromoCodeAndStatus(@Param("promoCode") String promoCode, @Param("status") OrderStatus status);

        @Query("SELECT o FROM Order o WHERE o.promoCode = :promoCode AND o.user.id = :customerId")
        List<Order> findByPromoCodeAndCustomerId(@Param("promoCode") String promoCode,
        ...
        @Query("SELECT o FROM Order o WHERE o.promoCode = :promoCode AND o.createdAt BETWEEN :from AND :to")
        List<Order> findByPromoCodeAndCreatedAtBetween(@Param("promoCode") String promoCode,
