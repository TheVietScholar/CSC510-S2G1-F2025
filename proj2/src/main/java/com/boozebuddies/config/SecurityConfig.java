        ...
        .authorizeHttpRequests(
            auth ->
                auth
                    ...
                    // Age verification
                    .requestMatchers(HttpMethod.POST, "/api/users/{id}/verify-age").authenticated()
                    
                    // Role management (ADMIN only)
                    .requestMatchers("/api/users/*/roles/**").hasRole("ADMIN")
                    .requestMatchers("/api/users/*/merchant").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.DELETE, "/api/merchants/**").hasRole("ADMIN")
                    
                    // ADMIN or MERCHANT_ADMIN can update merchants (ownership checked in controller)
                    .requestMatchers(HttpMethod.PUT, "/api/merchants/{id}").hasAnyRole("ADMIN", "MERCHANT_ADMIN")
                    
                    // MERCHANT_ADMIN specific endpoints (their own merchant)
                    .requestMatchers("/api/merchants/my-merchant/**").hasRole("MERCHANT_ADMIN")

                    // ==================== PRODUCT ENDPOINTS ====================
                    .requestMatchers(HttpMethod.GET, "/api/products/**").authenticated()
                    .requestMatchers(HttpMethod.POST, "/api/products/**").hasAnyRole("ADMIN", "MERCHANT_ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/products/**").hasAnyRole("ADMIN", "MERCHANT_ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/products/**").hasAnyRole("ADMIN", "MERCHANT_ADMIN")
                    ...
                    .requestMatchers("/api/orders/merchant/**").hasRole("MERCHANT_ADMIN")
                    
                    // DRIVER can view assigned orders
                    .requestMatchers("/api/orders/driver/**").hasRole("DRIVER")
                    ...
                    .requestMatchers("/api/deliveries/driver/**").hasRole("DRIVER")
                    .requestMatchers(HttpMethod.POST, "/api/deliveries/{id}/pickup").hasRole("DRIVER")
                    .requestMatchers(HttpMethod.POST, "/api/deliveries/{id}/deliver").hasRole("DRIVER")
                    .requestMatchers(HttpMethod.POST, "/api/deliveries/{id}/verify-age").hasRole("DRIVER")
                    .requestMatchers(HttpMethod.PUT, "/api/deliveries/{id}/location").hasRole("DRIVER")
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/drivers/available").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/drivers/{id}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/drivers/{id}/certification").hasRole("ADMIN")
                    
                    // Drivers manage their own profile
                    .requestMatchers("/api/drivers/my-profile/**").hasRole("DRIVER")
