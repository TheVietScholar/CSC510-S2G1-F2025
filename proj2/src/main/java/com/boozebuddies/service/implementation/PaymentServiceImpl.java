...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Payment processPayment(Order order, String paymentMethod) {
        ...
        System.out.println("[PAYMENT] Processed payment of " + payment.getAmount() +
    ...
    public Payment refundPayment(Order order, String reason) {
        ...
        payments.add(refund);
        System.out.println("[PAYMENT] Refunded " + refund.getAmount() +
                " for Order ID: " + order.getOrderId() +
                " Reason: " + reason);
        return refund;
    }
     ...
     * For now, any non-null, non-empty string is considered valid.
     */
    @Override
