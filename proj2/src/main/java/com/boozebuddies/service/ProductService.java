...
public interface ProductService {
  ...
  /**
   * Get all products in the system (including unavailable).
   * Admin use only.
   */
  List<Product> getAllProducts();

  /**
   * Get only available products (available = true).
   * Public endpoint for customers to browse.
   */
   ...
   * (You mentioned working on category if needed - this will be useful)
   */
