...
public class DriverMapperTest {
    ...
    public void testDriverToDriverDTO() {
        ...
        assertEquals(testDriver.getCurrentLatitude(), dto.getCurrentLatitude(), "Current Latitude should match");
        assertEquals(testDriver.getCurrentLongitude(), dto.getCurrentLongitude(), "Current Longitude should match");
        assertEquals(testDriver.getRating(), dto.getRating(), "Rating should match");
        assertEquals(testDriver.getTotalDeliveries(), dto.getTotalDeliveries(), "Total Deliveries should match");
        assertEquals(testDriver.getCertificationStatus().name(), dto.getCertificationStatus(), "Certification Status should match");
        assertEquals(testDriver.getCertification().getCertificationNumber(), dto.getCertification().getCertificationNumber(), "Certification Number should match");
    }   
    ...
    public void testDriverDTOToDriver() {
        ...
        assertEquals(testDriver.getLicensePlate(), driver.getLicensePlate(), "License Plate should match");
        assertEquals(testDriver.isAvailable(), driver.isAvailable(), "Availability should match");
        assertEquals(testDriver.getCurrentLatitude(), driver.getCurrentLatitude(), "Current Latitude should match");
        assertEquals(testDriver.getCurrentLongitude(), driver.getCurrentLongitude(), "Current Longitude should match");
        assertEquals(testDriver.getRating(), driver.getRating(), "Rating should match");
        assertEquals(testDriver.getTotalDeliveries(), driver.getTotalDeliveries(), "Total Deliveries should match");
        assertEquals(testDriver.getCertificationStatus(), driver.getCertificationStatus(), "Certification Status should match");
        assertEquals(testDriver.getCertification().getCertificationNumber(), driver.getCertification().getCertificationNumber(), "Certification Number should match");
    }
