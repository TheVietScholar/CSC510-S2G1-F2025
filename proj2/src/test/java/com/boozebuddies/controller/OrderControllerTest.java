...
public class OrderControllerTest {
                                ...
                                .perform(
                                                post("/api/orders")
                                                                ...
                                                                .content(objectMapper
                                                                                .writeValueAsString(testCreateRequest)))
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value(org.hamcrest.Matchers.containsString(
                                                                                "only create orders for yourself")));
        }
        ...
        void createOrder_NullUserId_Success() throws Exception {
                CreateOrderRequest requestWithNullUserId = CreateOrderRequest.builder()
                                .userId(null)
                                .merchantId(1L)
                                .items(testCreateRequest.getItems())
                                .build();
        ...
        void getMyMerchantOrders_NoMerchantAssigned() throws Exception {
                User adminWithoutMerchant = User.builder().id(20L).name("Admin Without Merchant").merchantId(null)
                                .build();
        ...
        void getMyMerchantOrders_Exception() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value(org.hamcrest.Matchers.containsString(
                                                                                "Failed to retrieve merchant orders")));
        }
        ...
        void getDriverOrders_Exception() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value(org.hamcrest.Matchers.containsString(
                                                                                "Failed to retrieve driver orders")));
        }
        ...
        @Test
        @DisplayName("PUT /api/orders/{id}/status should return 400 with invalid ID")
        void updateOrderStatus_InvalidId() throws Exception {
                mockMvc
                                .perform(put("/api/orders/0/status").param("status", "CONFIRMED"))
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.success").value(false))
                                .andExpect(jsonPath("$.message").value("Invalid order ID"));
        ...
        void getOrderById_MerchantAdminWithNullMerchantId() throws Exception {
                User merchantAdminNullId = User.builder().id(20L).name("Merchant Admin").merchantId(null).build();
        ...
        void createOrder_EmptyItemsList() throws Exception {
                CreateOrderRequest emptyRequest = CreateOrderRequest.builder().userId(1L).merchantId(1L)
                                .items(List.of()).build();
        ...
        @Test
        @DisplayName("POST /api/orders/{id}/cancel should handle order cancellation business logic exception")
        ...
        void getOrdersByDistance_Success() throws Exception {
                ...
                mockMvc
                                .perform(get("/api/orders/by-distance")
                                                .param("latitude", String.valueOf(latitude))
                                                .param("longitude", String.valueOf(longitude))
                                                .param("radiusKm", String.valueOf(radiusKm)))
                                .andExpect(status().isOk())
        ...
        @DisplayName("GET /api/orders/by-distance should accept boundary latitude values")
        void getOrdersByDistance_BoundaryLatitude() throws Exception {
                when(orderService.getOrdersWithinDistance(-90.0, -78.9, 10.0))
                                .thenReturn(List.of(testOrder));
                when(orderMapper.toDTO(testOrder)).thenReturn(testOrderDTO);
        ...
        @DisplayName("GET /api/orders/by-distance should accept boundary longitude values")
        void getOrdersByDistance_BoundaryLongitude() throws Exception {
                when(orderService.getOrdersWithinDistance(35.5, -180.0, 10.0))
                                .thenReturn(List.of(testOrder));
                when(orderMapper.toDTO(testOrder)).thenReturn(testOrderDTO);
        ...
        void getOrdersByDistance_Exception() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value(org.hamcrest.Matchers
                                                                .containsString("Failed to retrieve orders")));
        }
        ...
        @DisplayName("PUT /api/orders/{id}/status should handle various status values")
        void updateOrderStatus_VariousStatuses() throws Exception {
                String[] statuses = { "PENDING", "CONFIRMED", "PREPARING", "READY", "OUT_FOR_DELIVERY",
                                "DELIVERED", "CANCELLED" };
