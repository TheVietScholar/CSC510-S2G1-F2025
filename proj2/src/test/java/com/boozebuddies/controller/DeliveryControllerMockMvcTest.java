...
public class DeliveryControllerMockMvcTest {
    ...
    void assignDriverToOrder_exception_returnsBadRequest() throws Exception {
        ...
        mockMvc
                ...
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.startsWith("Failed to assign driver:")));
    }
    ...
    void cancelDelivery_success() throws Exception {
        ...
        when(deliveryService.cancelDelivery(1L, "Customer requested")).thenReturn(testDelivery);
        when(deliveryMapper.toDTO(testDelivery)).thenReturn(mapped);
    ...
    void cancelDelivery_exception_returnsBadRequest() throws Exception {
        ...
        mockMvc
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.success").value(false))
                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers.startsWith("Failed to cancel delivery:")));
    }
