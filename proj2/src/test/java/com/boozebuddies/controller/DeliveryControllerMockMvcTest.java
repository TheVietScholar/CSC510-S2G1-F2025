...
public class DeliveryControllerMockMvcTest {
        ...
        void updateDeliveryStatus_success() throws Exception {
                ...
                DeliveryDTO mapped = DeliveryDTO.builder()
                                .id(1L)
                                .orderId(100L)
                                .driverId(10L)
        ...
        void updateDeliveryStatus_notFound() throws Exception {
                ...
                mockMvc.perform(put("/api/deliveries/999/status?status=DELIVERED")).andExpect(status().isNotFound());
        }
                ...
                mockMvc
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value(org.hamcrest.Matchers
                                                                .startsWith("Failed to update delivery status:")));
        }
        ...
        void cancelDelivery_success() throws Exception {
                ...
                when(deliveryService.cancelDelivery(eq(1L), eq("Customer%20requested"))).thenReturn(testDelivery);
                when(deliveryMapper.toDTO(testDelivery)).thenReturn(mapped);
        ...
        void getActiveDeliveries_exception_returnsBadRequest() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(jsonPath("$.message").value(org.hamcrest.Matchers
                                                .startsWith("Failed to retrieve active deliveries:")));
        }
        ...
        void getDeliveriesByDriver_exception_returnsBadRequest() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(jsonPath("$.message").value(
                                                org.hamcrest.Matchers.startsWith("Failed to retrieve deliveries:")));
        }
        ...
        void getDeliveryById_exception_returnsBadRequest() throws Exception {
                ...
                mockMvc
                                ...
                                .andExpect(jsonPath("$.success").value(false))
                                .andExpect(jsonPath("$.message").value(
                                                org.hamcrest.Matchers.startsWith("Failed to retrieve delivery:")));
        }
}
