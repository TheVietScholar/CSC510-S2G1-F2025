...
@WebMvcTest(controllers = DriverController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
...
public class DriverControllerTest {
    ...
    @MockBean
    private com.boozebuddies.service.UserService userService;
