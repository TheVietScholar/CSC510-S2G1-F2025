...
class UserServiceImplTest {
  ...
  void testRegister_UserNull() {
    assertThrows(
        IllegalArgumentException.class, () -> userService.register(null), "User cannot be null");
  }
  ...
  void testRegister_NameNull() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> userService.register(testUser), "Name is required");
  }
  ...
  void testRegister_PhoneNull() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> userService.register(testUser), "Phone is required");
  }
  ...
  void testUpdateUser_Success() {
    User updatedUser = User.builder().email("newemail@example.com").build();
  ...
  void testUpdateUser_UpdatePassword() {
    User updatedUser = User.builder().passwordHash("NewPass123").build();

    User existingUser = User.builder().id(1L).passwordHash("OldPass123").build();
  ...
  void testUpdateUser_UpdateDateOfBirth() {
    ...
    User updatedUser = User.builder().dateOfBirth(newDate).build();
