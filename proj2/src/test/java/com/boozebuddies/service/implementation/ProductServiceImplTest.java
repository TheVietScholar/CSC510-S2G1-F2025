...
class ProductServiceImplTest {
  ...
  void testDeleteProduct_CallsRepositoryDelete() {
    ...
    void testSearchProducts_WithKeyword_ReturnsMatchingProducts() {
        Product matchingProduct1 = Product.builder()
            .id(1L)
            .name("Craft IPA Beer")
            .price(new BigDecimal("8.99"))
            .merchant(testMerchant)
        ...
        Product matchingProduct2 = Product.builder()
            .id(2L)
            .name("Lager")
            .price(new BigDecimal("7.99"))
            .merchant(testMerchant)
...
>>>>>>> c557bc6 (Fixed Test code changes from role management feature implementation)
    ...
    void testGetAvailableProducts_ReturnsOnlyAvailableProducts() {
        Product availableProduct1 = Product.builder()
            .id(1L)
            .name("Available 1")
            .available(true)
            .build();
            
        Product availableProduct2 = Product.builder()
            .id(2L)
            .name("Available 2")
            .available(true)
            .build();
        ...
        when(productRepository.findAll()).thenReturn(Arrays.asList(availableProduct1, availableProduct2, unavailableProduct));
    ...
    void testGetProductsByMerchant_ReturnsCorrectMerchantProducts() {
        ...
        Product merchant1Product = Product.builder()
            .id(1L)
        ...
        Product merchant2Product = Product.builder()
            .id(2L)
